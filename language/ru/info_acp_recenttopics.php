...
$lang = array_merge($lang, array(
	...
	'RT_PAGE_NUMBER_EXP'			=> 'Можно отображать большее число тем в списке при использовании страниц. Установите 1 для отключения данной функции. Если установлено значение 0, список будет иметь столько страниц, сколько необходимо для отображения всем тем на конференции (не рекомендуется).',
	'RT_PARENTS'					=> 'Показывать родительские форумы',
	'RT_PARENTS_EXP'				=> 'Если включено, будут отображены названия родительских подфорумов и форумовдля тем в списке.',
